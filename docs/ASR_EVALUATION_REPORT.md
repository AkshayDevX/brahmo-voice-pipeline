...
1. **Underperformed Compared to Sarvam AI:** Sarvam AI achieved significantly higher accuracy and lower Word Error Rate (WER) across our benchmark suite (average WER of 44.9% vs 77.4% for Deepgram Nova-3, and node accuracy of 99.3% vs 91.3%).
...
3. **Lacks Transliteration Mode:** Deepgram has no built-in transliteration/romanization mode for Indic languages, outputting in native scripts which resulted in 100% Levenshtein Word Error Rate (WER) against our Romanized gold-standard reference transcripts.
