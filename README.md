...
- **Medical Intelligence Correction:** Pre-processes transcripts to fix drug brand names and tag regional critical negations (e.g., Telugu _"ivvaledu"_, Hindi _"mat do"_) before LLM inference.
...
- API keys for Groq, Sarvam AI, and DeepSeek configured.
...
_Calculated metrics (WER, MTA, Negation Preserved, Node Accuracy) will be saved directly to the PostgreSQL `accuracy_results` table._
